...
\section{Goal}
This report presents the process and results of comparing multiple classification models on a given dataset. The workflow includes loading and preprocessing the data, training and evaluating classifiers, ranking their performance, and drawing conclusions based on the results.
...
\begin{itemize}
    ...
    \item Potential improvements and future work.
\end{itemize}
